...
```{r, echo=FALSE}
DT::datatable(data.frame(features=differential_expression$rna$sig_feature[[cluster]]$up))
```

#### Proteomics

```{r, echo=FALSE}
DT::datatable(data.frame(features=differential_expression$proteins$sig_feature[[cluster]]$up))
```
...
```{r, echo=FALSE}
DT::datatable(differential_expression$rna[[cluster]])
```

#### Proteomics

```{r, echo=FALSE}
DT::datatable(differential_expression$proteins[[cluster]])
```
...
```{r, echo=FALSE}
moduleTraitCor=module[[cluster]]$down$moduleTraitCor
moduleTraitPvalue=module[[cluster]]$down$moduleTraitPvalue
...
print(getMatrix(TF[[cluster]]$up,name='pval'))
print(getMatrix(TF[[cluster]]$up,name='odds.ratio'))
}
...
print(getMatrix(TF[[cluster]]$down,name='pval'))
print(getMatrix(TF[[cluster]]$down,name='odds.ratio'))
}
```

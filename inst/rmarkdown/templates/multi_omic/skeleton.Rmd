...
```{r, echo=FALSE}
  ...
  DT::datatable(data.frame(features=weights$weights$ranked_weights_positive$rna))
...
```{r, echo=FALSE}
  DT::datatable(data.frame(features=weights$weights$ranked_weights_positive$protein))
```
...
```{r, echo=FALSE}
  ...
  DT::datatable(data.frame(features=weights$weights$ranked_weights_negative$rna))
...
```{r, echo=FALSE}
  ...
  DT::datatable(data.frame(features=weights$weights$ranked_weights_negative$protein))
```
...
```{r conditional_block, echo=FALSE,eval = run_TF_pos}
...
```{r conditional_block, echo=FALSE, eval= run_TF_neg}

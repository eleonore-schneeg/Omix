...
#'
#' @param multiassay Multiassay experiment object generated by Omix
#' @param integration multi-omics clustering integration method. Default to `iCluster`
...
#'
#' @param igraph Multi-omics network
#' @param community_object Community object generated by  `.communities_network`function

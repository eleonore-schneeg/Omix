...
#' @export
#'
single_omic_report <- function(multiassay,
  ...
  uniomic=list()
  uniomic=multiassay@metadata[c('DEG','DEP','single_omic_comparison')]
  uniomic$param$slot=slot
  uniomic$param$database=database
  uniomic$metadata=multiassay@colData
  uniomic$parameters_analysis_rna = multiassay@metadata$parameters$single_omic$de$rna
  uniomic$parameters_analysis_protein = multiassay@metadata$parameters$single_omic$de$protein
  uniomic$parameters_processing_rna = multiassay@metadata$parameters$processing$rna
  ...
  rmarkdown::render(
    system.file(
      "rmarkdown/templates/single_omic/skeleton.Rmd",
      package = "Omix"
    ),
    params = list(

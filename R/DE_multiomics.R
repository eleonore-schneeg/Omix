...
#' @param dependent Dependent variable for the differential expression analysis, usually the
#' disease group variable
#' @param covariates Technical and biological covariates. Set as NULL is data is denoised.
...
DE_multiomics <- function(multiassay,
  ...
  names(df_rna) <- gsub(pattern = "-", replacement = "vs", x = names(res), fixed = TRUE)

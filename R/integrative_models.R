...
#' @param design Possible designs for integration are `cor`(strength of correlation between PC1 of omics layers)
#' or `full` (The strength of all relationships between dataframes is maximised (= 1) – a “fully connected” design)
#' @param range
#'

...
library(readr)
library(badger)
comparison_table <- read_csv("man/figures/comparison_table_new.csv")
```
...
The experiments described in our vignettes rely on in house data from the Multi-Omics Atlas Project, which may be obtained from the synapse portal for registered users.
...
Navigate to Omix and open the Omix.Rproj file.
